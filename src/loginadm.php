...
<body>
  ...
  <main>
    <div class="container">
      ...
      <form name = "f1" action="admlogin.php" method="post">
                  <div class="pt-4 pb-2">
                    <h5 class="card-title text-center pb-0 fs-4">Faça login na sua conta</h5>
                    <p class="text-center small">Digite seu nome de usuário e senha para entrar como adm</p>
                  </div>
                  ...
                  <form class="row g-3 needs-validation" novalidate>
                    ...
                    <div class="col-12">
                      ...
                      <div class="input-group has-validation">
                        ...
                        <div class="invalid-feedback">Por favor coloque seu email</div>
                      </div>
                    </div>
