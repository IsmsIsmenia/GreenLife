...
<body>
  ...
  <aside id="sidebar" class="sidebar">
    ...
    <ul class="sidebar-nav" id="sidebar-nav">
      ...
      <li class="nav-item">
        <a class="nav-link "  href="principaladm.php">
  ...
  <main id="main" class="main">
    ...
    <div class="pagetitle">
      ...
      <nav>
        <ol class="breadcrumb">
          <li class="breadcrumb-item"><a href="principaladm.php">Principal Adm</a></li>
        ...
        <div class="card card-solid">
          ...
          <div class="row">
            ...
            <?php
                        ...
                        ?>
              <form action="buscadenuncias.php" method="POST">
                <br>
              ...
              <table class="table table-responsive table-bordered " id="tabeladenuncia">
                <thead>
                 <tr>
                  <th>Código</th>
                  <th>Nome</th>
                  <th>E-mail</th>
                  <th>Categoria da Denúncia</th>
                  <th>Coordenadas</th>
                  <th>Data</th>
                  <th>Hora</th>
                  <th>Checado</th>
              ...
              $sql = "select coddenuncia , nome , email , telefone,
              catd ,coord , DATE_FORMAT(datad, '%d/%m/%Y') as data , hora, checado
              from tbdenuncia where nome like '%$texto%' ";
           ...
           if($consulta){
              ...
              while(  $linha=$consulta->fetch_array(MYSQLI_ASSOC)){
                    ...
                    <td>'.$linha['checado'].'</td>
                    <td>
                    <button id="'.$linha['coddenuncia'].'" value="checar" title="Checar" class="btn btn-sm btn-primary" ><img src="img/icons8-editar-16.png"></button>
                    </td>
                  </tr>';
              }
              }else{
  ...
  <script>
     $('#tabeladenuncia').on('click','button',function(){
      let valor = $(this).val();
      if (valor == 'checar'){
        swal({
      title: "Deseja confirmar essa Denúncia?",
    ...
    .then((willUpdate) => {
      if (willUpdate) {
        let id=$(this).attr('id');
        let checado='S'
          $.post('updated.php',{id:id,checado:checado},function(retorno1){
            if(retorno1 != 'erro'){
                swal("Denúncia checada!", {
          icon: "success",
            });
      }})
      } else {
