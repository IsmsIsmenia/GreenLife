            ...
            <div class="col-lg-4 col-md-6 d-flex flex-column align-items-center justify-content-center">
              ...
              <div class="card mb-3">
                ...
                <?php
                        ...
                        ?>
                <form name="f1" method="POST" action="salvacadadm.php">

                  <div class="pt-4 pb-2">
                    <h5 class="card-title text-center pb-0 fs-4">Novo Admin</h5>
                    <p class="text-center small">Insira os dados para criar um novo admin!</p>
                  </div>
                  ...
                  <form class="row g-3 needs-validation" novalidate>
                    ...
                    <div class="col-12">
                      <button class="btn btn-primary w-100" type="submit">Criar Adm!</button>
                    </div>
                  </form>
